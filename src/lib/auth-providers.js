    ...
    options: [
      {
        ...
        models: [
          ...
          { id: "qwen3.6-35b-a3b", label: "Qwen3.6 35B A3B", contextWindow: 262144, input: ["text", "image"], reasoning: true },
          { id: "qwen3.6-27b", label: "Qwen3.6 27b", contextWindow: 252000, input: ["text", "image"], reasoning: true },
          ...
          { id: "qwen3.6-35b-1MC", label: "qwen3.6-35b-1MC", contextWindow: 1000000, input: ["text", "image"], reasoning: true },          
        ],
